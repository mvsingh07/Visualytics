...
@Component({
  selector: 'app-extensionadmin',
  templateUrl: './extensionadmin.component.html',
  styleUrls: ['./extensionadmin.component.scss']
})
export class ExtensionadminComponent implements OnInit {
